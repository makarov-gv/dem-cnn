...
MLFLOW_URI = 'http://spbhws381-ubuntu.geoscan.lan:5000'  # URI for MLflow tracking server
...
DATASET_DIR = os.path.abspath('/home/makarov/Desktop/Yandex.Disk/dem_cnn/dataset_640')  # to load dataset generated by extract_data.ipynb
